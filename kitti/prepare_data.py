...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--use_gauss_mask",
        action="store_true",
        help="Replace intensity with 2D Gaussian mask",
    )
    parser.add_argument(
        "--gauss_sigma_scale",
        type=float,
        default=0.3,
        help="Sigma scale as fraction of box size",
    )
    parser.add_argument(
        "--output_suffix",
        default="",
        help="Suffix for output pickle names (e.g., _gauss)",
    )
    ...
    if args.output_suffix:
        output_prefix = output_prefix + args.output_suffix.lstrip("_")
